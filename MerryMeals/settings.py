"""
Django settings for MerryMeals project.
...
WSGI_APPLICATION = 'MerryMeals.wsgi.application'
...
# For setting the custom User model instead of default user model
